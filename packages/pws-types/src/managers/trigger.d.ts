...
export type TriggerManager = {
    ...
    getTriggerObjektConfigList(triggerOrganisationUnitId: PsrGuid, triggerObjectType: PsrEntityObjectType): Promise<Iterable<PsrNotifyTriggerConfig>>;
    setNotifyDataTriggerConfig(reason: PsrNotifyTriggerReason, dataId: PsrGuid, overrideType: PsrNotifyTriggerType | null, checkRights: boolean, filterObjects: any[]): Promise<void> | void;
    setNotifyOuTriggerConfig(reason: PsrNotifyTriggerReason, organisationUnitId: PsrGuid, objectType: PsrEntityObjectType, overrideType: PsrNotifyTriggerType | null, checkRights: boolean, filterObjects: any[]): Promise<void> | void;
    removeNotifyDataTriggerConfig(reason: PsrNotifyTriggerReason, dataId: PsrGuid): Promise<void> | void;
    removeNotifyOuTriggerConfig(reason: PsrNotifyTriggerReason, organisationUnitId: PsrGuid, objectType: PsrEntityObjectType): Promise<void> | void;
};
