...
export type ActiveDirectoryManager = {
    ...
    checkActiveDirectoryConnection(profileId: PsrGuid | null, domainName: string, userName: string, authTypes: PsrActiveDirectoryAuthenticationType | boolean, encryptedUserPassword?: string | null): Promise<boolean>;
    ...
    getActiveDirectoryElementList(profileId: PsrGuid, elementName: string, search: string, fullSearch: boolean): Promise<Record<string, unknown>[]>;
    getSpecificActiveDirectoryElements(profileId: PsrGuid, objectGuids: string[]): Promise<Record<string, unknown>[]>;
    importActiveDirectory(profileId: PsrGuid, newActiveDirectoryObjects: Record<string, unknown>[], excludeItems: Record<string, unknown>[], parentOrganisationUnitId: PsrGuid | null, tokenIdentity?: string | null): Promise<void> | void;
    syncActiveDirectory(profileId: PsrGuid, tokenIdentity?: string | null): Promise<void> | void;
    generateActiveDirectorySummaryDetails(profileId: PsrGuid, newActiveDirectoryObjects: Record<string, unknown>[], excludeItems: Record<string, unknown>[], parentOrganisationUnitId: PsrGuid | null, tokenIdentity?: string | null, withSyncInfo?: boolean): Promise<void> | void;
