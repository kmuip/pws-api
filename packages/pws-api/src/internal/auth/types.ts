...
export type SessionServiceLike = {
  ...
  setTokens(
    ...
    onTouched?: ((methodName: string) => void) | null,
...
export function createAuthenticationError(message: string, details?: unknown) {
