...
import type { PsrListFilter, PsrOrganisationUnit, PsrOrganisationUnitStructure, PsrOrganisationUnitUser, PsrOrganisationUnitGroup } from '../data';
export type OrganisationUnitManager = {
    ...
    changeOrganisationUnitPassword(userId: PsrGuid, oldHash: PsrByteArray, newHash: PsrByteArray, newSalt: PsrByteArray, newEncryptedPrivateKey: PsrByteArray): Promise<void> | void;
    ...
    addOrganisationUnitGroup(group: PsrOrganisationUnitGroup, publicKey: PsrByteArray, encryptedGroupPrivateKey: PsrByteArray, parentOrganisationUnitId: PsrGuid | null): Promise<PsrOrganisationUnitGroup>;
    ...
    addOrganisationUnitUser(user: PsrOrganisationUnitUser, userPasswordHash: PsrByteArray, userPasswordSalt: PsrByteArray, publicKey: PsrByteArray, encryptedUserPrivateKey: PsrByteArray, encryptedCurrentUserPrivateKey: PsrByteArray, clientHashAlgorithm?: string | null, parentOrganisationUnitId?: PsrGuid | null): Promise<PsrOrganisationUnitUser>;
